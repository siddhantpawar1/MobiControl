...
public class WCAndroidEnterpriseBinding {

	private static final String JSON_LOCATOR_FILE = "WCGlobalSettingsPageLocators.json";
	public WebDriver driver;

	public WCAndroidEnterpriseBinding(WebDriver driver) {
		this.driver = driver;
	} 

	public void CreateEnterpriseBindings() throws IOException, InterruptedException {
		...
		sotiActions.sotiSendkeys("googleUName", JSON_LOCATOR_FILE, "soti2407automation@gmail.com", driver);
		...
		sotiActions.sotiClickweb("completeSignUp", JSON_LOCATOR_FILE, driver);
		System.out.println("This account was already entered and therefore just re-enroll works");

		// Switch back to Second browser (Second window)
		driver.switchTo().window(childWindowId);

		// Re-Enroll to the G-Account
		sotiActions.sotiClickweb("reEnroll", JSON_LOCATOR_FILE, driver);
		System.out.println("This account was already binded before so just re-enroll");
