...
public class WCAndroidEnterpriseBindingStepDefinitions extends base {
	...
	public void android_enterprise_binding_should_be_completed() throws Throwable {
		WCAndroidEnterpriseBinding CreateAEBinding = new WCAndroidEnterpriseBinding(driver);
		CreateAEBinding.CreateEnterpriseBindings();
	}
